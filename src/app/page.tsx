      ...
      <section className="app-page">
        <div className="flex flex-col gap-4 border-b border-line pb-6 lg:flex-row lg:items-start lg:justify-between">
          ...
          <a
            ...
            className="flex min-h-[5rem] w-full max-w-[10rem] items-center justify-center rounded-[1.8rem] border border-line bg-[rgba(250,248,244,0.98)] p-6 transition hover:border-accent hover:bg-white lg:min-h-[13rem]"
          >
            <img
